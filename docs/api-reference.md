...
## Transformer API
The training of the TransformerModel operates on multiple layers of the architecture. For that reason, it was preferred to provide the API needed for training as in the example found in [Quick Start](docs/quickstart#transformermodel-example.md).
